<?php require_once("includes/header.php"); ?>
	...
	<div class="panel panel-success col-lg-12 col-md-12 col-sm-12 col-xs-12" style="box-shadow: 10px 10px #A4BD9E; padding:0px; margin:0px;" >
        ...
        <div class="panel-body" style="background-color: #f5f5f5;"> 
            ...
            <h2 class="text-center" style="margin-top: 0; margin-bottom: 1%; padding: 0;">Call Us <span class="glyphicon glyphicon-phone"></span>&nbsp;0468 465 004</h2>
            <div class="container col-lg-12">                
                ...
                <div class="col-lg-6 col-sm-12 col-md-6 col-xs-12">
                    ...
                    <a class="btn btn-lg btn-success" style="margin-bottom: 5%;" href="contact_us.php">
                        <span class="glyphicon glyphicon-chevron-right"></span>&nbsp;Get a free quote
                    </a>
                </div> 
                <div class=" container-fluid col-lg-6 col-sm-12 col-md-6 col-xs-12">
                    <?php require_once("caraousal.php"); ?> 
                </div>
                <br>
                <div class="container col-lg-12 col-sm-12 col-md-12 col-xs-12">
                <p class="text-center" style="font-family:Cursive; padding:0.4em; font-size:2.1em;">
